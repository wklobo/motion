...
/*
 * Constants for simplified lux calculation
 * according TAOS Inc.
 */
#define LUX_SCALE 14
...
uint8_t tsl2561_write_byte_data (void *_tsl, uint8_t reg, uint8_t value) 
{
  ...
  tsl2561_t *tsl = TO_TSL(_tsl);
	printf(">> %s()#%d\n", __FUNCTION__, __LINE__);
  uint8_t data = i2c_smbus_write_byte_data(tsl->file, reg, value); //org
  //uint8_t data = i2c_smbus_write_byte_data(tsl, reg, value);
	printf(">> %s()#%d\n", __FUNCTION__, __LINE__);
...
//tsl2561.c: In function ‘tsl2561_write_byte_data’:
//tsl2561.c:209:47: warning: passing argument 1 of ‘tsl2561_write_byte_data’ makes pointer from integer without a cast [-Wint-conversion]
//   uint8_t data = i2c_smbus_write_byte_data(tsl->file, reg, value);
//                                            ~~~^~~~~~
//tsl2561.c:206:39: note: expected ‘void *’ but argument is of type ‘int’
// uint8_t tsl2561_write_byte_data(void *_tsl, uint8_t reg, uint8_t value)
//                                 ~~~~~~^~~~
...
{
  tsl2561_t *tsl = TO_TSL(_tsl);
  uint16_t data = i2c_smbus_write_word_data((void*)tsl->file, reg, value);
...
//tsl2561.c: In function ‘tsl2561_write_word_data’:
//tsl2561.c:252:48: warning: passing argument 1 of ‘tsl2561_write_word_data’ makes pointer from integer without a cast [-Wint-conversion]
//   uint16_t data = i2c_smbus_write_word_data(tsl->file, reg, value);
//                                             ~~~^~~~~~
//tsl2561.c:249:40: note: expected ‘void *’ but argument is of type ‘int’
// uint16_t tsl2561_write_word_data(void *_tsl, uint8_t reg, uint8_t value)
//                                  ~~~~~~^~~~
...
int16_t tsl2561_read_word_data(void *_tsl, uint8_t reg) 
{
  ...
  int16_t data = i2c_smbus_read_word_data((void *)tsl->file, reg);
...
//
//tsl2561.c:287:46: warning: passing argument 1 of ‘tsl2561_read_word_data’ makes pointer from integer without a cast [-Wint-conversion]
//   int16_t data = i2c_smbus_read_word_data(tsl->file, reg);
//                                           ~~~^~~~~~
//tsl2561.c:279:38: note: expected ‘void *’ but argument is of type ‘int’
// int16_t tsl2561_read_word_data(void *_tsl, uint8_t reg)
//                                ~~~~~~^~~~
...
void* tsl2561_init(int address, const char* i2c_device_filepath) 
{
  ...
  if(tsl->i2c_device == NULL) {
	...
	printf(">> %s()#%d device='%p'\n", __FUNCTION__, __LINE__, tsl->i2c_device);
